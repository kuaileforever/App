        ...
        return(
            <View style={styles.container}>
                <Image style={styles.bg}
                       source={require('../../../../res/images/login_bg.png')}>
                    ...
                    <View>
                        <TouchableOpacity style={styles.text_input}
                                          onPress={()=>{navigate('AlarmClock')}}>
                            <Text
                                style={{fontSize:px3dp(55),alignSelf:'center',
                                margin:px3dp(20)}}
                            >
                                闹钟设置
                            </Text>
                        ...
                        <TouchableOpacity style={styles.text_input}
                            ...
                            <Text style={{fontSize:px3dp(55),alignSelf:'center',
                                   margin:px3dp(20)}}>
                                主题
                            </Text>
                        </TouchableOpacity>
