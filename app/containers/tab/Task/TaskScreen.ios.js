            ...
            <View style={styles.container}>
                <View style={[styles.row,styles.addTop]}>
                    <View style={styles.wrap}>
                        <TouchableOpacity onPress={()=>navigate('DayPlan')}>
                        <View >
                    ...
                    <View style={styles.wrap}>
                        <TouchableOpacity onPress={()=>navigate('WeekPlan')}>
                        <View >
                ...
                <View style={[styles.row,styles.addBottom]}>
                    <View style={styles.wrap}>
                        <TouchableOpacity onPress={()=>navigate('MonthlyPlan')}>
                        <View >
                    ...
                    <View style={styles.wrap}>
                        <TouchableOpacity onPress={()=>navigate('YearPlan')}>
                        <View >
